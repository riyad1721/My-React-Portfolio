...
const data = [
  {
    name: "Syed Hussain",
    review:
      "Reyad exceeded our expectations, delivering innovative AI solutions that transformed our operations. Their clear communication, rapid deployment, and client-centric approach made the collaboration seamless. Highly recommend for anyone seeking a top-notch AI engineer!",
    loction: "America",
    img: img,
  },
  {
    ...
    review:
      "Md. Reyad Hossain from Suffix IT Limited demonstrated exceptional expertise, elevating our projects with cutting-edge AI solutions. Their strategic insights, efficient implementation, and collaborative spirit have been invaluable to our success. Highly recommend for any organization seeking AI excellence.",
    loction: "Bangladesh",
    img: img2,
  },
];
